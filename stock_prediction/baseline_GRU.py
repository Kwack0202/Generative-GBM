    ...
    def process(self):
        ...
        for stock_file in stock_files:
            ...
            for window_idx, (train_df, test_df, window_info) in enumerate(sliding_windows):
                ...
                save_path = f'./stock_prediction/pred_results/{model_name}/baseline/Train_{self.args.train_months}_Test_{self.args.sliding_test_months}/{self.args.exp_root_path}/{self.args.sector}/{ticker_name}/'
